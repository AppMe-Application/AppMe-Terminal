...
public class RootChecker {
    ...
    public boolean detectRootManagementApps(String[] additionalRootManagementApps) {
        ...
        packages.addAll(Arrays.asList(RootCheckerConstant.knownRootAppsPackages));
    ...
    public boolean detectPotentiallyDangerousApps(String[] additionalDangerousApps) {
        ...
        // Create a list of package names to iterate over from constants any others provided
        ArrayList<String> packages = new ArrayList<>();
        packages.addAll(Arrays.asList(RootCheckerConstant.knownDangerousAppsPackages));
    ...
    public boolean detectRootCloakingApps(String[] additionalRootCloakingApps) {
        ...
        // Create a list of package names to iterate over from constants any others provided
        ArrayList<String> packages = new ArrayList<>();
        packages.addAll(Arrays.asList(RootCheckerConstant.knownRootCloakingPackages));
    ...
    public boolean checkForBinary(String filename) {
        ...
        String[] pathsArray = RootCheckerConstant.suPaths;
    ...
    public boolean checkForRWPaths() {
        ...
        for (String line : lines) {
            ...
            for(String pathToCheck: RootCheckerConstant.pathsThatShouldNotBeWrtiable) {
    ...
    public boolean checkForRootNative() {
        ...
        String[] paths = new String[RootCheckerConstant.suPaths.length];
        for (int i = 0; i < paths.length; i++) {
            paths[i] = RootCheckerConstant.suPaths[i]+binaryName;
        }

        RootCheckerNative rootCheckerNative = new RootCheckerNative();
        try {
            rootCheckerNative.setLogDebugMessages(loggingEnabled);
            return rootCheckerNative.checkForRoot(paths) > 0;
        } catch (UnsatisfiedLinkError e) {
            return false;
        }
    }
