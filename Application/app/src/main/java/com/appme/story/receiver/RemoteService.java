...
public class RemoteService {
    ...
    public static final String SCREEN_RECORD_IS_RUNNING = "SCREEN_RECORD_IS_RUNNING";
    public static final String SCREEN_RECORD_IS_DONE = "SCREEN_RECORD_IS_DONE";

    // Fields for broadcast
    public static final String BASE_ACTION_SCREEN_STREAM = "com.appme.story.service";
    public static final String SERVICE_ACTION = BASE_ACTION_SCREEN_STREAM + ".ForegroundService.SERVICE_ACTION";

    public static final String SERVICE_PERMISSION = "com.appme.story.RECEIVE_BROADCAST";
