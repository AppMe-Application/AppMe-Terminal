package com.appme.story.application.shortcuts;
...
import com.appme.story.application.DebianRunShortcut;
import com.appme.story.engine.app.terminal.TermDebug;
import com.appme.story.engine.app.terminal.compat.AlertDialogCompat;
import com.appme.story.engine.app.terminal.compat.PRNGFixes;
import com.appme.story.engine.app.terminal.shortcuts.ColorValue;
import com.appme.story.engine.app.terminal.shortcuts.TextIcon;
import com.appme.story.engine.app.terminal.util.ShortcutEncryption;

import java.io.File;
import java.security.GeneralSecurityException;

public class AddDebianShortcut extends Activity {
    ...
    void makeShortcut() {
        ...
        img.setImageResource(com.appme.story.R.mipmap.ic_launcher);
    ...
    void buildShortcut(
        ...
        if (path != null      && !path.equals(""))      cmd.append(DebianRemoteInterface.quoteForBash(path));
        ...
        Intent target=  new Intent().setClass(context, DebianRunShortcut.class);
        target.setAction(AppConfig.DEBIAN_ACTION_RUN_SHORTCUT);
        target.putExtra(AppConfig.DEBIAN_EXTRA_SHORTCUT_COMMAND, cmdEnc);
        target.putExtra(AppConfig.DEBIAN_EXTRA_WINDOW_HANDLE, shortcutName);
