...
import com.appme.story.engine.app.fragments.TerminalDrawerFragment;
...
import com.appme.story.engine.app.terminal.TermViewFlipper;
import com.appme.story.engine.app.terminal.GenericTermSession;
import com.appme.story.engine.app.terminal.ShellTermSession; 
import com.appme.story.engine.app.terminal.CheckRoot; 
...
public class TerminalActivity extends AppCompatActivity implements UpdateCallback, SharedPreferences.OnSharedPreferenceChangeListener, View.OnClickListener {
    /**
	...
	private TerminalDrawerFragment mNavigationDrawerFragment;
    ...
    public static final String EXTRA_WINDOW_ID = "com.appme.story.window_id";
    ...
    private static final String ACTION_PATH_BROADCAST = "com.appme.story.broadcast.APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "com.appme.story.broadcast.PREPEND_TO_PATH";
    private static final String PERMISSION_PATH_BROADCAST = "com.appme.story.permission.APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "com.appme.story.permission.PREPEND_TO_PATH";
    ...
    private BroadcastReceiver mPathReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {   
            ...
            String path = null;
            if (action.equals(ACTION_PATH_BROADCAST)) {
                 ...
                 */
                result.putString(packageName, FolderMe.getSupportDir(context).getAbsolutePath());
                path = makePathFromBundle(result);
                setResultCode(Activity.RESULT_OK);
                mSettings.setAppendPath(path);
                
            } else if (action.equals(ACTION_PATH_PREPEND_BROADCAST)) {
    ...
    public void onCreate(Bundle icicle) {
        ...
        TSIntent = new Intent(this, TerminalService.class);
        ...
        sp = PreferenceManager.getDefaultSharedPreferences(TerminalActivity.this);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerClosed(View drawerView) {
				...
				if (!mHaveFullHwKeyboard) {			
					KeyboardUtils.showSoftInput(TerminalActivity.this);
				}
            ...
            public void onDrawerOpened(View drawerView) {
				...
				KeyboardUtils.closeSoftInput(TerminalActivity.this);
		...
		mNavigationDrawerFragment = new TerminalDrawerFragment();
        ...
        if (actionBar != null) {
            ...
            actionBar.setSubtitle(FolderMe.get().getObbDir().getAbsolutePath());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_application_terminal, menu);
        MenuItemCompat.setShowAsAction(menu.findItem(R.id.menu_toggle_soft_keyboard), MenuItemCompat.SHOW_AS_ACTION_ALWAYS);
        MenuItemCompat.setShowAsAction(menu.findItem(R.id.menu_open_debian), MenuItemCompat.SHOW_AS_ACTION_IF_ROOM);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (mDrawerToggle.onOptionsItemSelected(item)) {
			...
			Intent openHelp = new Intent(Intent.ACTION_VIEW, Uri.parse(getString(R.string.terminal_help_url)));									 
	...
	private void showNotRootedDialog() {
        final Uri uri = Uri.parse(getString(R.string.terminal_rooting_url));
        AlertDialog.Builder builder = buildErrorDialog(getString(R.string.terminal_not_rooted));
        builder.setNegativeButton(R.string.terminal_what_root, new DialogInterface.OnClickListener() {
            @Override
	...
	private AlertDialog.Builder buildErrorDialog(String msg) {
        return new AlertDialog.Builder(this).setMessage(msg).setCancelable(true)
	...
	public void getNewWindow() {
        ...
        b.setMessage("Open Window With :");
        final Runnable newWindow = new Runnable() {
            @Override
            public void run() {
                doCreateNewWindow();
            }
        };
		final Runnable newRootWindow = new Runnable() {
            @Override
            public void run() {
        ...
        b.setPositiveButton("SuperUser", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					dialog.dismiss();
					mHandler.post(newRootWindow);
				}
			});

        b.setNegativeButton("User", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					dialog.dismiss();
					mHandler.post(newWindow);
				}
			});
        b.show();
	}
