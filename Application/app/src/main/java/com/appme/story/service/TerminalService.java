...
public class TerminalService extends Service implements TermSession.FinishCallback {
	/** Note that this is a symlink on the Android M preview. */
    @SuppressLint("SdCardPath")
    public static final String FILES_PATH = "/data/data/com.appme.story/files";
    ...
    public void onCreate() {
        ...
        String defValue = FolderMe.getSupportDir(getApplicationContext()).getAbsolutePath();
