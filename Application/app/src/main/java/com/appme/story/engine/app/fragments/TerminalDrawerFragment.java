...
public class TerminalDrawerFragment extends Fragment implements AdapterView.OnItemClickListener, ObservableScrollViewCallbacks, View.OnClickListener {
	
	private static final String TAG = TerminalDrawerFragment.class.getSimpleName();
     ...
     * number.
     */
    public static TerminalDrawerFragment newInstance(int number) {
        TerminalDrawerFragment fragment = new TerminalDrawerFragment();
    ...
    public void onResume() {
        ...
        Intent TSIntent = new Intent(mActivity, TerminalService.class);
