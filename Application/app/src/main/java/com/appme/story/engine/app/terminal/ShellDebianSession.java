 ...
 * upon stopping.
 */
public class ShellDebianSession extends GenericTermSession {
    private int mProcId;
    ...
    public ShellDebianSession(TermSettings settings, String initialCommand) throws IOException {
    ...
    private void initializeSession() throws IOException {
        ...
        if((mInitialCommand != null) && (mInitialCommand.equals("") == false))
            ...
            mProcId = createSubprocess(Environment.getDataDirectory() + "/data/com.appme.story/app_install/support/busybox sh", env);
    }
